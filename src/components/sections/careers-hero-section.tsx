    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
      ...
      >
        ...
        >
          ...
          <span className="font-serif italic font-medium">Fondi</span>.
        </h1>
        <p
          className="text-base leading-[1.65] text-neutral-600"
          style={{ maxWidth: "420px" }}
        >
          Súmate a una empresa que cada día ayuda a más personas a acceder al
          respaldo financiero que necesitan. Buscamos personas comprometidas,
          con actitud de servicio y ganas de crecer junto a nosotros.
        </p>
      </motion.div>
